  ...
  return (
    ...
    >
      <div className="grid md:grid-cols-2 gap-8 items-center relative">
        ...
        <div className="relative h-[520px] w-full perspective-1000 isolate">
          {CARDS.map((c, i) => {
            const isActive = i === active;
          ...
          <div className="flex flex-col md:flex-row gap-8 items-stretch justify-center relative min-h-[550px]">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-white/60 text-base md:text-lg leading-relaxed">To be the global champion in Al data solutions, igniting a culture of innovation and sustainability that enriches lives and transforms communities worldwide.</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-darkSerpent/60 text-base md:text-lg leading-relaxed">To develop and deploy cutting edge Al technologies that solve real-world problems, empower communities, and advance sustainable practices. We are committed to fostering a culture of innovation, collaborating with stakeholders across sectors, and making a meaningful impact on society and the environment.</p>
