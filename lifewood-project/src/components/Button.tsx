...
export default function Button({
  ...
  const base = 'inline-flex items-center justify-center gap-2 font-bold px-12 py-4 rounded-2xl text-sm uppercase tracking-widest shadow-lg transition-all duration-300 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer';
