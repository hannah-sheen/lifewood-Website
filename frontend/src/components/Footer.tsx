...
export default function Footer() {
  return (
    <footer className="bg-darkSerpent text-paper py-16">
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm opacity-80">
            <li><a href="#global" className="hover:text-saffaron">Global Footprint</a></li>
            <li><a href="#clients" className="hover:text-saffaron">Our Clients</a></li>
            <li><a href="#innovation" className="hover:text-saffaron">Innovation</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p className="text-sm opacity-80 mt-6">© 2026 Lifewood Data Technology. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
