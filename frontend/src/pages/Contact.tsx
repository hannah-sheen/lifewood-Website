                  ...
                  <div className="space-y-8">
                    <div className="flex gap-6 group">
                      ...
                      <div>
                        ...
                        <a href="mailto:info@lifewood.com" className="text-lg font-bold text-darkSerpent hover:text-saffaron transition-colors">info@lifewood.com</a>
                      </div>
                    </div>
              ...
              <Animate delay={300}>
                <div className="bg-white p-10 md:p-14 rounded-[3rem] shadow-2xl shadow-darkSerpent/10 border border-darkSerpent/[0.03]">
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    {/* <div className="space-y-2">
                      <label className="text-[10px] font-black uppercase tracking-widest text-darkSerpent/40 ml-1">Subject</label>
                      <select className="w-full bg-seaSalt border-none rounded-2xl p-4 focus:ring-2 focus:ring-saffaron/50 transition-all outline-none text-darkSerpent font-medium appearance-none">
