...
// // Replaced with your provided list
...
//        mapRef.current.focusLocation(loc.lng, loc.lat);
//     }
//   };
...
//             {/* UPDATED: Circle Indicator with better visibility for green/dark sections */}
...
//       {/* SECTION: Core Values */}
//       <section id="values" className="py-25 bg-darkSerpent text-white">
//         <div className="max-w-7xl mx-auto px-6">
//           <div className="mb-20">
//             <Animate>
...
//                   <button
//                     key={i}
//                     onClick={() => handleMapFocus(loc)} // Triggers both scroll and map move
//                     className="px-4 py-2 rounded-full border border-darkSerpent/10 text-[10px] font-black uppercase tracking-widest text-darkSerpent hover:bg-darkSerpent hover:text-white transition-all shadow-sm bg-white active:scale-95"
//                   >
//                     {loc.name}
//                   </button>
//                 ))}
